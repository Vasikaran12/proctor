...
class _IndividualPageState extends State<IndividualPage> {
  ...
  void connect() {
    ...
    socket = io("http://192.168.106.70:3000", <String, dynamic>{
      "transports": ["websocket"],
      "autoConnect": false,
    });
    socket.connect();
    socket.emit("signin", Provider.of<UserProvider>(context, listen: false).faculty.email);
  ...
  void sendMessage(String message, String sourceId, String targetId) {
    ...
    socket.emit("message",
        {"message": message, "sourceId": sourceId, "targetId": sourceId});
  }
