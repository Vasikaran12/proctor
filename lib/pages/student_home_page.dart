...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Hi, ${Provider.of<UserProvider>(context).student.name} !',
      ...
      body: isloading
          ...
          : Center(
              ...
              child: IdCard(
                  name: Provider.of<UserProvider>(context).student.name,
                  regnum: Provider.of<UserProvider>(context).student.regnum,
                  pname:
                      Provider.of<UserProvider>(context).student.faculty.name,
                  pphone:
                      Provider.of<UserProvider>(context).student.faculty.phone,
                  pemail:
                      Provider.of<UserProvider>(context).student.faculty.email),
            )),
    );
  }
}
