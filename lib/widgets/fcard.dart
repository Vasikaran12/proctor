...
class FIdCard extends StatefulWidget {
  ...
  final String phone;
  final String email;
  const FIdCard({super.key, required this.name, required this.email, required this.phone});
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      launchUrl(Uri.parse("mailto:${widget.email}")); 
                        ...
                        InkWell(
                          onTap: () async {
                            Navigator.push(context, MaterialPageRoute(builder: (_) => FRegisterPage(readOnly: false, faculty: Faculty(name: widget.name, email: widget.email, phone: widget.phone), )));
                          },
                          child: Container(
                            width: MediaQuery.of(context).size.width * 0.1,
                            height: MediaQuery.of(context).size.width * 0.1,
